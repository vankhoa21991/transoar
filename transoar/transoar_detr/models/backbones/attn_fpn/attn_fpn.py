...
from transoar.transoar_detr.models.backbones.attn_fpn.decoder_blocks import DecoderDefAttnBlock
from transoar.transoar_detr.models.backbones.attn_fpn.encoder_blocks import (
    EncoderCnnBlock,
    EncoderSwinBlock,
    PatchMerging,
    ConvPatchMerging
