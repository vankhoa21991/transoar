...
def segmentation2bbox(segmentation_maps, padding, box_format='cxcyczwhd', normalize=True):
    ...
    padding: padding to apply to bounding boxes
    box_format: format of bounding boxes
    normalize: whether to normalize bounding boxes to [0, 1]
    '''
    batch_bboxes = []
    batch_classes = []
    ...
    for map_ in segmentation_maps:
        ...
        print(batch_bboxes, batch_classes)
